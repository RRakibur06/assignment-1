export default function SingleProperty({ heading, price, qty1, room1, qty2, room2, image }) {
    return (
        <div class="p-4 bg-white rounded-lg border border-gray-600/10">
            <img
                src={image}
                alt="property" className=" h-[250px]" />

            <div class="p-6">
                <h4 class="text-2xl font-bold cursor-pointer">{heading}</h4>

                <div class="mt-2">
                    <span class="text-xl font-extrabold text-blue-600">${price}</span> /M
                </div>
            ...
            <div class="flex justify-between p-4 text-gray-700 border-t border-gray-300">
                <div class="flex items-center">
                    ...
                    <p><span class="font-bold text-gray-900">{qty1}</span> {room1}</p>
                </div>
                <div class="flex items-center">
                    <svg class="w-6 h-6 mr-3 text-gray-600 fill-current" xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24">
                    ...
                    <p><span class="font-bold text-gray-900">{qty2}</span> {room2}</p>
                </div>
            </div>
        </div>
    );
